...
namespace Crop_Deal1.Migrations
{
    ...
    [Migration("20230518193257_add_password_salthash_to_database")]
    partial class add_password_salthash_to_database
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Crop_Deal1.Models.Crop", b =>
                {
                    b.HasOne("Crop_Deal1.Models.Crop_detail", "Crop_Detail")
                        .WithOne("Crop")
                        .HasForeignKey("Crop_Deal1.Models.Crop", "Crop_detailid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
